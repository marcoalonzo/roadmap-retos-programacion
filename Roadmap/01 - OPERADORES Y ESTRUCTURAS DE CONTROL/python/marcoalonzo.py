...
name1 = 'Marco'
name2 = 'Alonzo'
print(f'Hello there {name1} and {name2}')       # Hello there Marco and Alonzo - Newer way to do things as of python 3.6
print('Hello there {} and {}'.format(name1, name2))# Hello there Marco and Alonzo
print('Hello there %s and %s' %(name1, name2))  # Hello there Marco and Alonzo --> you can also use %d, %f, %r for integers, floats, string representations of objects respectively
...
my_dict = {'name': 'Marco Alonzo', 'age': 30, 'magic_power': False}
my_dict['name']                      # Marco Alonzo
len(my_dict)                         # 3
list(my_dict.keys())                 # ['name', 'age', 'magic_power']
list(my_dict.values())               # ['Marco Alonzo', 30, False]
list(my_dict.items())                # [('name', 'Marco Alonzo'), ('age', 30), ('magic_power', False)]
my_dict['favourite_snack'] = 'Grapes'# {'name': 'Marco Alonzo', 'age': 30, 'magic_power': False, 'favourite_snack': 'Grapes'}
...
my_dict.update({'cool': True})                                         # {'name': 'Marco Alonzo', 'age': 30, 'magic_power': False, 'favourite_snack': 'Grapes', 'cool': True}
{**my_dict, **{'cool': True} }                                         # {'name': 'Marco Alonzo', 'age': 30, 'magic_power': False, 'favourite_snack': 'Grapes', 'cool': True}
